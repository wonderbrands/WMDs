    ...
    data() {
        return {
            ...
            taskDefinitions: [
                ...
                { id: "dispatch_ful", title:"Despacho Fulfillment y Mayoreo", description:"Entrega a paquetería de órdenes fulfillment y de mayoreo", fetch: false, label: "Escanear WH/DFUL o SO", view: "DispatchComponentFul", permission: "WMDs Operator - Dispatch", context: "open_dfull_operation", instructions: "Escanea la operación WH/DFUL/xxxx o la SO de mayoreo para comenzar", buttons_to_add: true, buttons_to_subtract: true, stock_input_add: false, backorder: true, extra_products: false, res_model: 'stock.picking', scan_source: true, scan_dest: false, any_source: true, any_dest: true, check_empty_dest_location: false },
